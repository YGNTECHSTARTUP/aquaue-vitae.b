    ...
    <div className="bg-teal-500 overflow-hidden">
      <div className="container mx-auto px-4 py-12 md:py-20">
        <div className="flex flex-col md:flex-row items-center">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold mb-4">#DRINKITUP</h1>
            <p className="text-xl md:text-2xl mb-6">Pure, Safe and Healthy drinking water for a better you.</p>
